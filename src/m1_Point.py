...
class Point(object):
    ...
    def move_to(self,x,y):
        ...
        self.distance_traveled = self.distance_traveled + ((self.x - self.old_x)**2 + (self.y - self.old_y)**2)**(1/2)
    ...
    def closer_to(self, p2, p3):
        dp1 = ((self.x - p2.x)**2 + (self.y - p2.y)**2)**(1/2)
        dp2 = ((self.x - p3.x)**2 + (self.y - p3.y)**2)**(1/2)
